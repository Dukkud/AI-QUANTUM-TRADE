...
core=QuantumCore(); risk=RiskEngine(); adaptive=AdaptiveEngine(); paper=PaperWorld(); live_gate=ClientLiveGate(); training_policy=RealtimeTrainingPolicy(); telemetry=HourlyTelemetryLedger(); evidence=EvidenceMachine(); _last_telemetry_hour=None
